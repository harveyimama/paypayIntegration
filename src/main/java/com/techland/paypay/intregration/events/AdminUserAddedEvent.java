...
@Immutable
@TechLandEvent(externalName = "Security.UserAddedEvent")
public class AdminUserAddedEvent implements PayPayEvent, Serializable {
	...
	public AdminUserAddedEvent(String id, String username, String email, String fullname, String role, String userId,
